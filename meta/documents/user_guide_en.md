...
2. Click on **DilemmataTheme**.<br /> → The plugin will open.
3. Click on **Files » resources » css » dilemmata.min.css** in the directory tree.
...
2. Go to the **Stylesheet (DilemmataTheme)** area.
...
**DilemmataTheme** allows you to override the templates of **Ceres** with your own content. To do so, enter the code in the template and override the template. In the following, setting up the homepage is explained. Set up the other templates the same way.
